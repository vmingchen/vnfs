	...
	static inline bool xdr_attrlist4(XDR * xdrs, attrlist4 *objp)
	{
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->attrlist4_val,
		     (u_int *) & objp->attrlist4_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
 ...
 */
		if (xdrs->x_op == XDR_FREE)
			return true;
		if (!xdr_array
		    (xdrs, &map, (u_int *) & objp->bitmap4_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_sec_oid4(XDR * xdrs, sec_oid4 *objp)
	{
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->sec_oid4_val,
		     (u_int *) & objp->sec_oid4_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_utf8string(XDR * xdrs, utf8string *objp)
	{
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->utf8string_val,
		     (u_int *) & objp->utf8string_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_pathname4(XDR * xdrs, pathname4 *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->pathname4_val,
		     (u_int *) & objp->pathname4_len, XDR_ARRAY_MAXLEN, sizeof(component4),
	...
	static inline bool xdr_fs_location4(XDR * xdrs, fs_location4 *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->server.server_val,
		     (u_int *) & objp->server.server_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_fs_locations4(XDR * xdrs, fs_locations4 *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->locations.locations_val,
		     (u_int *) & objp->locations.locations_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_nfsacl41(XDR * xdrs, nfsacl41 *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->na41_aces.na41_aces_val,
		     (u_int *) & objp->na41_aces.na41_aces_len, XDR_ARRAY_MAXLEN,
					       ...
					       layout_content4 *objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->loc_body.loc_body_val,
		     (u_int *) & objp->loc_body.loc_body_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_layouthint4(XDR * xdrs, layouthint4 *objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->loh_body.loh_body_val,
		     (u_int *) & objp->loh_body.loh_body_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_device_addr4(XDR * xdrs, device_addr4 *objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->da_addr_body.da_addr_body_val,
		     (u_int *) & objp->da_addr_body.da_addr_body_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_layoutupdate4(XDR * xdrs, layoutupdate4 *objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->lou_body.lou_body_val,
		     (u_int *) & objp->lou_body.lou_body_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
						  ...
						  layoutreturn_file4 *objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->lrf_body.lrf_body_val,
		     (u_int *) & objp->lrf_body.lrf_body_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
					       ...
					       threshold_item4 *objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->thi_hintlist.thi_hintlist_val,
		     (u_int *) & objp->thi_hintlist.thi_hintlist_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_mdsthreshold4(XDR * xdrs, mdsthreshold4 *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->mth_hints.mth_hints_val,
		     (u_int *) & objp->mth_hints.mth_hints_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_fattr4_acl(XDR * xdrs, fattr4_acl *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->fattr4_acl_val,
		     (u_int *) & objp->fattr4_acl_len, XDR_ARRAY_MAXLEN, sizeof(nfsace4),
						      ...
						      objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->fattr4_fs_layout_types_val,
		     (u_int *) & objp->fattr4_fs_layout_types_len, XDR_ARRAY_MAXLEN,
						   ...
						   fattr4_layout_types *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->fattr4_layout_types_val,
		     (u_int *) & objp->fattr4_layout_types_len, XDR_ARRAY_MAXLEN,
		     sizeof(layouttype4), (xdrproc_t) xdr_layouttype4))
			return false;
		return true;
	}
						  ...
						  ssv_mic_plain_tkn4 *objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->smpt_orig_plain.smpt_orig_plain_val,
		     (u_int *) & objp->smpt_orig_plain.smpt_orig_plain_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_ssv_mic_tkn4(XDR * xdrs, ssv_mic_tkn4 *objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->smt_hmac.smt_hmac_val,
		     (u_int *) & objp->smt_hmac.smt_hmac_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
						   ...
						   ssv_seal_plain_tkn4 *objp)
	{
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->sspt_confounder.sspt_confounder_val,
		     (u_int *) & objp->sspt_confounder.sspt_confounder_len, XDR_BYTES_MAXLEN))
			return false;
		if (!inline_xdr_u_int32_t(xdrs, &objp->sspt_ssv_seq))
			return false;
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->sspt_orig_plain.sspt_orig_plain_val,
		     (u_int *) & objp->sspt_orig_plain.sspt_orig_plain_len, XDR_BYTES_MAXLEN))
			return false;
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->sspt_pad.sspt_pad_val,
		     (u_int *) & objp->sspt_pad.sspt_pad_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
						    ...
						    objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->ssct_iv.ssct_iv_val,
		     (u_int *) & objp->ssct_iv.ssct_iv_len, XDR_BYTES_MAXLEN))
			return false;
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->ssct_encr_data.ssct_encr_data_val,
		     (u_int *) & objp->ssct_encr_data.ssct_encr_data_len, XDR_BYTES_MAXLEN))
			return false;
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->ssct_hmac.ssct_hmac_val,
		     (u_int *) & objp->ssct_hmac.ssct_hmac_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
						    ...
						    objp)
	{
		...
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->fls_info.fls_info_val,
		     (u_int *) & objp->fls_info.fls_info_len, XDR_BYTES_MAXLEN))
			return false;
						  ...
						  fs_locations_item4 *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->fli_entries.fli_entries_val,
		     (u_int *) & objp->fli_entries.fli_entries_len, XDR_ARRAY_MAXLEN,
						  ...
						  fs_locations_info4 *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->fli_items.fli_items_val,
		     (u_int *) & objp->fli_items.fli_items_len, XDR_ARRAY_MAXLEN,
					       ...
					       multipath_list4 *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->multipath_list4_val,
		     (u_int *) & objp->multipath_list4_len, XDR_ARRAY_MAXLEN,
					...
					nfsv4_1_file_layout_ds_addr4 *objp)
	{
		if (!xdr_array
		    (xdrs,
		     ...
		     nflda_stripe_indices_len, XDR_ARRAY_MAXLEN, sizeof(uint32_t),
		...
		if (!xdr_array
		    (xdrs,
		     ...
		     nflda_multipath_ds_list_len, XDR_ARRAY_MAXLEN, sizeof(multipath_list4),
						    ...
						    objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->nfl_fh_list.nfl_fh_list_val,
		     (u_int *) & objp->nfl_fh_list.nfl_fh_list_len, XDR_ARRAY_MAXLEN,
 ...
 */
	...
	static inline bool xdr_SECINFO4resok(XDR * xdrs, SECINFO4resok *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->SECINFO4resok_val,
		     (u_int *) & objp->SECINFO4resok_len, XDR_ARRAY_MAXLEN, sizeof(secinfo4),
	...
	static inline bool xdr_gsshandle4_t(XDR * xdrs, gsshandle4_t *objp)
	{
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->gsshandle4_t_val,
		     (u_int *) & objp->gsshandle4_t_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
						    ...
						    objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->bca_sec_parms.bca_sec_parms_val,
		     (u_int *) & objp->bca_sec_parms.bca_sec_parms_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_ssv_sp_parms4(XDR * xdrs, ssv_sp_parms4 *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->ssp_hash_algs.ssp_hash_algs_val,
		     (u_int *) & objp->ssp_hash_algs.ssp_hash_algs_len, XDR_ARRAY_MAXLEN,
		     sizeof(sec_oid4), (xdrproc_t) xdr_sec_oid4))
			return false;
		if (!xdr_array
		    (xdrs, (char **)&objp->ssp_encr_algs.ssp_encr_algs_val,
		     (u_int *) & objp->ssp_encr_algs.ssp_encr_algs_len, XDR_ARRAY_MAXLEN,
		     sizeof(sec_oid4), (xdrproc_t) xdr_sec_oid4))
			return false;
	...
	static inline bool xdr_ssv_prot_info4(XDR * xdrs, ssv_prot_info4 *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->spi_handles.spi_handles_val,
		     (u_int *) & objp->spi_handles.spi_handles_len, XDR_ARRAY_MAXLEN,
						   ...
						   CREATE_SESSION4args *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->csa_sec_parms.csa_sec_parms_val,
		     (u_int *) & objp->csa_sec_parms.csa_sec_parms_len, XDR_ARRAY_MAXLEN,
		     sizeof(callback_sec_parms4),
		     (xdrproc_t) xdr_callback_sec_parms4))
			return false;
		return true;
						   ...
						   GETDEVICELIST4resok *objp)
	{
		...
		if (!xdr_array
		    (xdrs,
		     ...
		     gdlr_deviceid_list_len, XDR_ARRAY_MAXLEN, sizeof(deviceid4),
					       ...
					       LAYOUTGET4resok *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->logr_layout.logr_layout_val,
		     (u_int *) & objp->logr_layout.logr_layout_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_SET_SSV4args(XDR * xdrs, SET_SSV4args *objp)
	{
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->ssa_ssv.ssa_ssv_val,
		     (u_int *) & objp->ssa_ssv.ssa_ssv_len, XDR_BYTES_MAXLEN))
			return false;
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->ssa_digest.ssa_digest_val,
		     (u_int *) & objp->ssa_digest.ssa_digest_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_SET_SSV4resok(XDR * xdrs, SET_SSV4resok *objp)
	{
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->ssr_digest.ssr_digest_val,
		     (u_int *) & objp->ssr_digest.ssr_digest_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
						 ...
						 TEST_STATEID4args *objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->ts_stateids.ts_stateids_val,
		     (u_int *) & objp->ts_stateids.ts_stateids_len, XDR_ARRAY_MAXLEN,
						  ...
						  TEST_STATEID4resok *objp)
	{
		if (!xdr_array
		    (xdrs,
		     ...
		     XDR_ARRAY_MAXLEN, sizeof(nfsstat4), (xdrproc_t) xdr_nfsstat4))
			return false;
		return true;
	}
	...
	xdr_data4(XDR *xdrs, data4 *objp)
	{
		register int32_t *buf;
		 ...
		 if (!xdr_bytes(xdrs, (char **)&objp->d_data.data_val,
		                (u_int *) &objp->d_data.data_len, XDR_BYTES_MAXLEN))
			 return false;
		return true;
	}
	...
	xdr_app_data_hole4(XDR *xdrs, app_data_hole4 *objp)
	{
		register int32_t *buf;
		 ...
		 if (!xdr_bytes(xdrs, (char **)&objp->adh_data.data_val,
		                (u_int *)&objp->adh_data.data_len, XDR_BYTES_MAXLEN))
			 return false;
		return true;
	}
	...
	xdr_data_protect_info4(XDR *xdrs, data_protect_info4 *objp)
	{
		register int32_t *buf;
		 ...
		 if (!xdr_bytes(xdrs, (char **)&objp->pi_data.pi_data_val,
		                (u_int *) &objp->pi_data.pi_data_len, XDR_BYTES_MAXLEN))
			 return false;
		return true;
	}
	...
	xdr_data_protected4(XDR *xdrs, data_protected4 *objp)
	{
		register int32_t *buf;
		 ...
		 if (!xdr_bytes(xdrs, (char **)&objp->pd_info.pd_info_val,
		                (u_int *)&objp->pd_info.pd_info_len, XDR_BYTES_MAXLEN))
			 return false;
		 if (!xdr_bytes(xdrs, (char **)&objp->pd_data.pd_data_val,
		                (u_int *)&objp->pd_data.pd_data_len, XDR_BYTES_MAXLEN))
			 return false;
		return true;
	}
	...
	static inline bool xdr_WRITE_PLUS4args(XDR *xdrs, WRITE_PLUS4args *objp)
	{
		...
		if (!xdr_array(xdrs, (char **)&objp->wp_data.wp_data_val,
			       (u_int *)&objp->wp_data.wp_data_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_READ_PLUS4resok(XDR *xdrs, read_plus_res4 *objp)
	{
		...
		if (!xdr_array(xdrs,
			       ...
			       XDR_ARRAY_MAXLEN, sizeof(contents), (xdrproc_t)xdr_contents))
			return false;
		return true;
	}
	...
	static inline bool xdr_COMPOUND4args(XDR * xdrs, COMPOUND4args *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->argarray.argarray_val,
		     (u_int *) & objp->argarray.argarray_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_COMPOUND4res(XDR * xdrs, COMPOUND4res *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->resarray.resarray_val,
		     (u_int *) & objp->resarray.resarray_len, XDR_ARRAY_MAXLEN,
	...
	static inline bool xdr_notifylist4(XDR * xdrs, notifylist4 *objp)
	{
		if (!inline_xdr_bytes
		    (xdrs, (char **)&objp->notifylist4_val,
		     (u_int *) & objp->notifylist4_len, XDR_BYTES_MAXLEN))
			return false;
		return true;
	}
	...
	static inline bool xdr_CB_NOTIFY4args(XDR * xdrs, CB_NOTIFY4args *objp)
	{
		...
		if (!xdr_array
		    (xdrs, (char **)&objp->cna_changes.cna_changes_val,
		     (u_int *) & objp->cna_changes.cna_changes_len, XDR_ARRAY_MAXLEN,
						    ...
						    objp)
	{
		...
		if (!xdr_array
		    (xdrs,
		     ...
		     rcl_referring_calls_len, XDR_ARRAY_MAXLEN, sizeof(referring_call4),
						...
						CB_SEQUENCE4args *objp)
	{
		...
		if (!xdr_array
		    (xdrs,
		     ...
		     csa_referring_call_lists_len, XDR_ARRAY_MAXLEN,
						       ...
						       objp)
	{
		if (!xdr_array
		    (xdrs, (char **)&objp->cnda_changes.cnda_changes_val,
		     (u_int *) & objp->cnda_changes.cnda_changes_len, XDR_ARRAY_MAXLEN,
