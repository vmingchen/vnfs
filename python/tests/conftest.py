"""Shared pytest fixtures for the vnfs_fs test suite."""
...
import vnfs_fs  # noqa: F401  (registers the "nfs4" protocol)
...
def nfs_fs():
    ...
    root = f"git/vnfs_fs_it_{os.getpid()}_{uuid.uuid4().hex[:8]}"
