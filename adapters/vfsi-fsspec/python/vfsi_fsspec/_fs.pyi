...
class VfsiFileSystem(AbstractFileSystem):
    ...
    def closed(self) -> bool: ...
    def close(self) -> None: ...
    def __enter__(self) -> VfsiFileSystem: ...
    ...
    def _open(
        ...
        cache_options: Optional[dict[str, Any]] = None,
        **kwargs: Any,
    ) -> Union[VfsiFile, BinaryIO]: ...
    def open_many(
        self,
        open_files: Sequence[Any],
        *,
        block_size: Optional[int] = None,
        cache_type: Optional[str] = None,
        cache_options: Optional[dict[str, Any]] = None,
        write_buffering: Optional[bool] = None,
        sizes: Optional[Sequence[Optional[int]]] = None,
    ) -> list[VfsiFile]: ...
    def commit_many(self, open_files: Sequence[VfsiFile]) -> None: ...
    ...
    def rm_file(self, path: Path) -> None: ...
    def rm(
        self,
        path: Union[Path, Sequence[Path]],
        recursive: bool = False,
